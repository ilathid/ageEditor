...
icon_resources = [(1, "age_editor_icon.ico")]
bitmap_resources = []
other_resources = []
other_resources = [(24, 1, MANIFEST_TEMPLATE % dict(prog="IlathidAgeEditor"))]
...
GUI2Exe_Target_1 = Target(
    # what to build
    script="IlathidAgeEditor.pyw",
    icon_resources=icon_resources,
    bitmap_resources=bitmap_resources,
    other_resources=other_resources,
    dest_base="IlathidAgeEditor",
    version="0.2",
    company_name="the Ages of Ilathid team",
    copyright="(c) 2012 the Ages of Ilathid team",
    name="IlathidAgeEditor"
    )
